import type {Metadata} from 'next';import './globals.css';import './yuri-redesign.css';import './site-arrows.css';import {config} from '@/data/site';import {Analytics} from '@/components/site/analytics';
